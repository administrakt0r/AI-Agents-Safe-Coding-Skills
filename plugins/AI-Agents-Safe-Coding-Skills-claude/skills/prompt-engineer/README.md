...
**Version:** 1.0.1  
**Status:** âœ¨ Zero-Config | ðŸŒ Universal
...
- **ðŸŽ¯ Intent Analysis:** Understands what you're trying to accomplish
- **ðŸ§  11 Frameworks:** RTF, Chain of Thought, RISEN, RODES, Chain of Density, RACE, RISE, STAR, SOAP, CLEAR, GROW
- **ðŸ”„ Framework Blending:** Combines multiple frameworks when needed
- **â“ Smart Clarification:** Only asks questions when critically needed
- **ðŸ“ Adaptive Output:** Matches prompt length to task complexity
- **ðŸŒ Universal:** Works in any project, any terminal context
- **ðŸª„ Magic Mode:** No technical explanations - just results
...
**Structure:** Role â†’ Task â†’ Format
...
**Structure:** Problem â†’ Step 1 â†’ Step 2 â†’ ... â†’ Solution
...
**Structure:** Iteration 1 (verbose) â†’ Iteration 2 â†’ ... â†’ Iteration 5 (maximum density)
...
2. **Identifies complexity**
   - Simple (1-2 sentences) â†’ Fast, minimal structure
   - Moderate (paragraph) â†’ Standard framework
   - Complex (detailed requirements) â†’ Advanced framework or blend

3. **Selects primary framework**
   - RTF â†’ Role-based tasks
   - Chain of Thought â†’ Step-by-step reasoning
   - RISEN/RODES â†’ Complex projects
   - RACE â†’ Communication
   - STAR â†’ Contextual problems
   - And so on...

4. **Blends secondary frameworks when needed**
   - RODES + Chain of Thought â†’ Complex technical projects
   - CLEAR + GROW â†’ Leadership goals
   - RACE + STAR â†’ Strategic communication
...
â”‚ 1. Analyze Intent      â”‚  What is the user trying to do?
â”‚    - Task type         â”‚  Coding? Writing? Analysis? Design?
â”‚    - Complexity        â”‚  Simple, moderate, complex?
â”‚    - Clarity           â”‚  Clear or ambiguous?
â””â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
         â†“
â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ 2. Clarify (Optional)  â”‚  Only if critically needed
â”‚    - Ask 2-3 questions â”‚  Multiple choice when possible
â”‚    - Fill missing gaps â”‚  
â””â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
         â†“
â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ 3. Select Framework(s) â”‚  Silent selection
â”‚    - Map task â†’ framework
â”‚    - Blend if needed   â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
         â†“
â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ 4. Generate Prompt     â”‚  Apply framework rules
â”‚    - Add role/context  â”‚  
â”‚    - Structure task    â”‚  
â”‚    - Define format     â”‚
â”‚    - Add examples      â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
         â†“
â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ 5. Output              â”‚  Clean, copy-ready
â”‚    Markdown code block â”‚  No explanations
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
```
...
â†’ Generates structured prompt with role, requirements, output format, examples
...
â†’ Generates audience-aware prompt with structure, tone, and content guidelines
...
â†’ Generates step-by-step analytical framework with visualization requirements
...
â†’ Generates decision framework with criteria, trade-offs, and validation
...
â†’ Generates learning path prompt with phases, resources, and milestones
...
**A:** Yes. It can interpret non-English source input, but it defaults the generated prompt to English unless you explicitly ask to preserve another language.
