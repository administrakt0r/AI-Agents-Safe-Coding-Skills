...
- If original prompt is already in English, keep the generated prompt in English
- If original prompt is in another language, translate the working draft to English unless the user explicitly asks to preserve the source language
