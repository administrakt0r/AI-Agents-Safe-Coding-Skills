...
description: When the user wants to submit their product to startup, SaaS, AI, or review directories for backlinks, domain rating, and discovery.
...
## When to Use
Use this skill when the user wants to submit a product to directories for distribution and SEO.
