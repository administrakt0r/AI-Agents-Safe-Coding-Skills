...
1. âœ… Always stream at every stage (transcription, LLM, synthesis)
2. âœ… Buffer entire LLM responses before synthesis
3. âœ… Mute transcriber during bot speech
4. âœ… Rate-limit audio chunks for interrupts
5. âœ… Maintain conversation history for context
6. âœ… Use proper error handling in worker loops
7. âœ… Cleanup resources in finally blocks
8. âœ… Use LINEAR16 PCM at 16kHz for audio
...
This skill is part of the AI-Agents-Safe-Coding-Skills repository. Contributions are welcome!
