...
- Workflows: [docs/users/workflows.md](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/blob/main/docs/users/workflows.md)
...
- **Codex plugin distribution** - formalized the root Codex plugin metadata in `.agents/plugins/marketplace.json` and `plugins/AI-Agents-Safe-Coding-Skills/.codex-plugin/plugin.json`, alongside generated bundle plugins.
...
- [@administrakt0r](https://github.com/administrakt0r) - 54 commits
...
- **[@administrakt0r](https://github.com/administrakt0r)** - Podcast Generation & Azure skills sync (PR #74).
...
- [@administrakt0r](https://github.com/administrakt0r) - Workflows architecture, docs, and release integration
...
- **Documentation**: Clarified in README.md and GETTING_STARTED.md that installation means cloning the full repo once; Starter Packs are curated lists to discover skills by role, not a different installation method (fixes [#44](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/issues/44)).
...
- [@administrakt0r](https://github.com/administrakt0r) - Voice AI Engine (PR #33)
...
- [@administrakt0r](https://github.com/administrakt0r) - PR #23
