---
name: ai-seo
description: "Optimize content for AI search engines, get cited by LLMs, and appear in AI answers (AI SEO, AEO, GEO). Use when the user asks about AI Overviews, ChatGPT/Perplexity optimization, or AI visibility."
risk: unknown
