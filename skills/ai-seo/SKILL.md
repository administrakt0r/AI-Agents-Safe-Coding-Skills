---
name: ai-seo
description: "When the user wants to optimize content for AI search engines, get cited by LLMs, or appear in AI-generated answers. Use this for 'AI SEO', 'AEO', 'LLM optimization', or 'AI visibility'."
risk: safe
...
- When you need to optimize content specifically to be cited by LLMs or AI assistants (ChatGPT, Claude, Perplexity).
- When you want to improve visibility in AI Overviews (Google AI Overviews).
- When you need to build content structures that AI engines can extract data from effectively.
