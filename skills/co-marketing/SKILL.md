...
description: "A co-marketing strategist that helps you identify ideal partners, brainstorm joint campaigns, evaluate partnership fit, and structure agreements."
metadata:
  version: 1.0.0
---
