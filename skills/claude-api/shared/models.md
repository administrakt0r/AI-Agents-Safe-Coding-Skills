...
|-------------------|---------------------|-------------------------------|----------------|------------|--------|
| Claude Opus 4.7   | `claude-opus-4-7`   | —                             | 200K (1M beta) | 128K       | Active |
...
- **Claude Opus 4.7** — Our most intelligent model for building agents and coding. Supports adaptive thinking (recommended), 128K max output tokens (requires streaming for large outputs). 1M context window available in beta via `context-1m-2025-08-07` header.
- **Claude Opus 4.6** — Our previous most intelligent model.
