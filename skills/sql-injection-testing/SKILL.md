...
> [!WARNING]
> **Authorized Use Only**
> This skill contains offensive security techniques. It must only be used on systems where you have explicit, written authorization to perform security testing. Unauthorized use is strictly prohibited.
