---
name: free-tools
description: Strategy guide for planning, evaluating, and building free engineering-as-marketing tools for lead generation and SEO.
version: 2.0.1
risk: safe
...
## When to Use
Use this skill when the user wants to plan, evaluate, or build a free tool for marketing purposes, such as lead generation, SEO value, or brand awareness.
