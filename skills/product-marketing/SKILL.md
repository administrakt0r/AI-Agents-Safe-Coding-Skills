...
description: "When the user wants to create or update their product marketing context document. Also use when the user mentions 'product context' or wants to avoid repeating foundational information."
metadata:
  version: 2.0.0
  risk: safe
