...
description: "Creates or updates the product marketing context document at `.agents/product-marketing.md`. Use when defining target audience, positioning, ICP, or foundational marketing context."
metadata:
  version: 2.0.0
risk: safe
...
Use this skill when:
- You need to create a new product marketing context document.
- You need to update positioning, target audience, ICP, or messaging.
- You are starting a new marketing project and want to ensure foundational information is documented for other skills to use.
