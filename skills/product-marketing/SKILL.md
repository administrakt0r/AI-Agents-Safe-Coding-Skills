...
description: "Use to create or update the product marketing context document (.agents/product-marketing.md) that all other skills reference. Triggers on 'product context', 'positioning', 'who is my target audience', 'describe my product', or 'ICP'. Always run this at the start of any new project."
metadata:
  version: 2.0.0
  risk: safe
  source: community
