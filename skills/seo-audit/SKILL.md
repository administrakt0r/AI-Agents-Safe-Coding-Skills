---
name: seo-audit
description: For auditing, reviewing, or diagnosing technical SEO issues, rankings, traffic drops, and site health checks.
metadata:
  version: 2.0.0
  category: marketing
risk: safe
...
Use this skill when auditing, reviewing, or diagnosing technical SEO issues, analyzing rankings, investigating traffic drops, evaluating on-page SEO, or performing site health checks.
...
- Never cross-locale canonical (Spanish to English) -- suppresses the non-canonical locale entirely
