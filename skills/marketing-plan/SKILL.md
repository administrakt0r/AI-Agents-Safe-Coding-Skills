---
name: marketing-plan
description: When the user needs a comprehensive marketing plan for a client or product. Generates an exhaustive 13-section plan structured by AARRR, customized to budget and stage. Outputs a Notion-paste-ready markdown document covering operations, positioning, onboarding, and retention.
metadata:
  version: 1.0.0
  risk: safe
