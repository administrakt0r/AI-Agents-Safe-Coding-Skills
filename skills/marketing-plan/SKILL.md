---
name: marketing-plan
description: A comprehensive marketing plan generator structured by AARRR (Acquisition, Activation, Retention, Referral, Revenue). Customizes plans to the client's budget, team, and stage, mapped to milestones. Outputs a Notion-paste-ready markdown document. Useful for fractional CMOs, consultants, or founders.
metadata:
  version: 2.3.0
  risk: safe
