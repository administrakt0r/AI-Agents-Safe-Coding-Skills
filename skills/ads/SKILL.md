---
name: ads
description: "When the user wants help with paid advertising campaigns on Google Ads, Meta, LinkedIn, or Twitter/X. Use this for PPC strategy, ROAS optimization, retargeting, and audience targeting. For creative iteration, see ad-creative. For landing pages, see cro."
metadata:
  version: 2.2.0
---
...
Use this skill when analyzing or planning paid advertising campaigns on platforms like Google Ads, Meta, LinkedIn, or Twitter/X.
...
For implementation, see the tools REGISTRY (not included). Key advertising platforms:

| Platform | Best For | MCP | Guide |
|----------|----------|:---:|-------|
| **Google Ads** | Search intent, high-intent traffic | ✓ | google-ads (not included) |
| **Meta Ads** | Demand gen, visual products, B2C | - | meta-ads (not included) |
| **LinkedIn Ads** | B2B, job title targeting | - | linkedin-ads (not included) |
| **TikTok Ads** | Younger demographics, video | - | tiktok-ads (not included) |

For tracking setup, see [references/conversion-tracking.md](references/conversion-tracking.md), ga4 (not included), segment (not included)
