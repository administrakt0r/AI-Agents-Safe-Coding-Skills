---
name: ads
description: "When the user wants help with paid advertising campaigns on Google Ads, Meta (Facebook/Instagram), LinkedIn, Twitter/X, or other ad platforms. Use this for campaign strategy, audience targeting, bidding, and optimization. For bulk ad creative generation and iteration, see ad-creative."
risk: safe
...
- Use when setting up or auditing paid media campaigns across platforms.
- Use for audience targeting, budget allocation, and bidding strategies.
- Use to optimize campaign architecture (campaigns, ad sets/groups) for ROAS/CPA.
...
|---|---|---|
| B2B strategy, funnel stages, budget splits, kill rules, lead quality, breakeven math | the b2b-paid-playbook.md reference (not included) | Demand lifecycle, leading/lagging signals, kill rules, offline conversion loop, U/B/F lead scoring, scaling quadrant |
| Meta operations: when to kill/graduate/scale an ad, fatigue, testing structure | the meta-decision-system.md reference (not included) | TCPL-anchored decision tree, ad-count ceiling, 80/20 CBO structure, fatigue bands, lead forms, Advantage+ transition |
| LinkedIn operations: bidding, audience sizing, scaling, benchmarks, TLAs, formats | the linkedin-b2b-playbook.md reference (not included) | Bidding progression, penetration scaling, sizing rules, funnel benchmarks, document/conversation ads, audit shortlist |
| Google Search: what to spend on first, structure, match types, negatives, PMax | the google-search-playbook.md reference (not included) | Intent ladder, account structure, match-type gates, negatives, bidding by volume, offline conversions, PMax guardrails |
| Named-account targeting, pipeline acceleration, cross-channel retargeting | the abm-playbook.md reference (not included) | LinkedIn/Meta ABM, list mechanics, acceleration campaigns, UTM cross-channel remarketing, ABM measurement |
| Generating Google RSAs | the rsa-output-spec.md reference (not included) | Mandatory output spec — limits, sidecars, template, self-check |
| Audience setup, tracking setup, launch checklists, copy formulas | the audience-targeting.md reference (not included) · the conversion-tracking.md reference (not included) · the platform-setup-checklists.md reference (not included) · the ad-copy-templates.md reference (not included) | Existing foundations |
...
**For detailed templates and headline formulas**: See the references/ad-copy-templates.md reference (not included)
...
**For detailed targeting strategies by platform**: See the references/audience-targeting.md reference (not included)
...
For hard kill/keep/scale thresholds, use the platform playbooks (see Reference Routing): the kill rules and breakeven CPL/CPC math live in the b2b-paid-playbook.md reference (not included), and Meta's full decision tree lives in the meta-decision-system.md reference (not included).
...
**For complete setup checklists by platform**: See the references/platform-setup-checklists.md reference (not included)

**For conversion pixel installation and event setup**: See the conversion tracking reference (not included)
...
When the user requests Google Ads RSAs, load the references/rsa-output-spec.md reference (not included) and follow it exactly — hard character limits, required sidecar artifacts (ad groups, negatives, sitelinks, callouts), output order, template shape, CFM medical compliance, and the pre-send self-check. Do not output any RSA that violates it.
...
For implementation, see the the tools registry reference (not included). Key advertising platforms:

| Platform | Best For | MCP | Guide |
|----------|----------|:---:|-------|
| **Google Ads** | Search intent, high-intent traffic | ✓ | the google-ads.md reference (not included) |
| **Meta Ads** | Demand gen, visual products, B2C | - | the meta-ads.md reference (not included) |
| **LinkedIn Ads** | B2B, job title targeting | - | the linkedin-ads.md reference (not included) |
| **TikTok Ads** | Younger demographics, video | - | the tiktok-ads.md reference (not included) |

For tracking setup, see the conversion tracking reference (not included), the ga4.md reference (not included), the segment.md reference (not included)
