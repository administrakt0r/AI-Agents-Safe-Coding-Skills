---
name: events
description: "When the user wants to plan, run, sponsor, speak at, or get pipeline from events (webinars, conferences, trade shows, etc). Covers hosting, sponsoring, speaking, and attending."
risk: safe
...
## When to Use
Use this skill when a user asks about event marketing, including running webinars, sponsoring conferences, getting ROI from trade shows, securing speaking slots, or optimizing event follow-up and pipeline generation.
