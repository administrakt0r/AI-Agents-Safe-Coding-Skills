---
name: cro
description: Optimize, improve, or increase conversions on any marketing page or form
  (homepage, landing pages, pricing pages, etc.). Provides a CRO analysis framework.
metadata:
  version: 2.0.0
  risk: safe
