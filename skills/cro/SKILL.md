---
name: cro
description: "When the user wants to optimize, improve, or increase conversions on any marketing page or form. Also use when the user asks for CRO or conversion rate optimization."
metadata:
  version: 2.0.0
  risk: safe
