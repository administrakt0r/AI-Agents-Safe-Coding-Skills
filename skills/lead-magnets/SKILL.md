---
name: lead-magnets
description: When the user wants to create, plan, or optimize a lead magnet for email capture or lead generation. Also use when the user mentions "lead magnet", "gated content", "ebook", "checklist", etc.
version: 2.0.0
risk: safe
...
## When to Use
Use this skill when you need to create, plan, or optimize a lead magnet for email capture or lead generation.
