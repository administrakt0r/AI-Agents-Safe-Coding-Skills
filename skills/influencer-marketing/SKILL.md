...
Use this skill when the user wants to run influencer, creator, or ambassador partnerships to promote their product. It covers finding and vetting partners, structuring deals, briefing creators, disclosure compliance, and measuring ROI.
...
For implementation, see the tools registry (not included).

| Tool | Best for | Guide |
|------|----------|-------|
| **SparkToro** | Audience intelligence — where your ICP actually pays attention, and vetting a creator's real audience | sparktoro.md (not included) |
