---
name: copy-editing
description: "Use this skill to systematically edit, review, or improve existing marketing copy, or refresh outdated content. Use it for proofreading, polishing, making copy better, tightening, cleaning up text, or sharpening messaging when the user already has copy and wants it improved rather than rewritten."
metadata:
  version: 2.0.0
  risk: safe
