---
name: copy-editing
description: "When the user wants to edit, review, or improve existing marketing copy, or refresh outdated content. Use when the user wants to polish, shorten, tighten up, clean, or proofread existing text instead of rewriting from scratch. For writing new copy, see copywriting."
metadata:
  version: 2.0.0
  risk: unknown
