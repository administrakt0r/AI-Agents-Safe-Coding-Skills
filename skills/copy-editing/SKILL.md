---
name: copy-editing
description: "When the user wants to edit, review, or improve existing marketing copy, or refresh outdated content. Use this when the user already has copy and wants it improved or refreshed rather than rewritten from scratch. For writing new copy, see copywriting."
metadata:
  version: 2.0.0
  risk: safe
...
Use this skill when:
- Reviewing or improving existing marketing copy
- Refreshing outdated content
- The user requests to edit, proofread, polish, or clean up text
...
For a final QA pass before delivering edits, work through the full checklist in the checklist reference — covering all seven sweeps plus pre-start and final-check items.
...
**For the full refresh checklist, refresh vs. rewrite decision matrix, and cadence guide**: See the content refresh reference
