...
description: "When the user wants help with public relations, earned media, press coverage, journalist outreach, or media strategy. Use this for earned media work — finding journalists, pitching stories, newsjacking, prepping podcast appearances, and responding to press requests."
version: 1.1.1
risk: safe
...
Use this skill when you need to handle public relations, earned media, newsjacking, journalist pitching, or preparing for a podcast appearance.
