const body = `This PR updates the \`azure-ai-ml-py\` skill documentation to verify compatibility with SDK version 1.35.0. No breaking API changes were found since GA that would invalidate the existing code snippets. The maintenance ledger has been updated, and a dated run log has been provided.
