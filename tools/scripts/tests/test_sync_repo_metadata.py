...
""",
    ...
    def test_sync_github_about_builds_expected_commands(self):
        ...
        sync_repo_metadata.sync_github_about(
            {
                "repo": "administrakt0r/AI-Agents-Safe-Coding-Skills",
                "total_skills_label": "1,304+",
            },
            dry_run=True,
            runner=fake_runner,
        ...
        self.assertEqual(repo_edit_args[:4], ["gh", "repo", "edit", "administrakt0r/AI-Agents-Safe-Coding-Skills"])
        self.assertIn("--description", repo_edit_args)
        self.assertIn("--homepage", repo_edit_args)
        self.assertIn("https://administrakt0r.github.io/AI-Agents-Safe-Coding-Skills/", repo_edit_args)

        self.assertEqual(topics_args[:4], ["gh", "api", "repos/administrakt0r/AI-Agents-Safe-Coding-Skills/topics", "--method"])
