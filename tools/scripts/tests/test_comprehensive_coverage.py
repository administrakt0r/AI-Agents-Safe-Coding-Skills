...
def analyze_skill_locations():
    ...
    try:
        ...
        allowed_collisions = ["applicationinsights-web-ts", "entra-agent-id", "azure-cosmos-rust", "azure-eventhub-rust", "azure-identity-rust", "azure-keyvault-certificates-rust", "azure-keyvault-keys-rust", "azure-keyvault-secrets-rust", "azure-storage-blob-rust"]
