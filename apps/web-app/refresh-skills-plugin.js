...
const UPSTREAM_REPO = 'https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills.git';
const UPSTREAM_NAME = 'upstream';
const REPO_TAR_URL = 'https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/archive/refs/heads/main.tar.gz';
const REPO_ZIP_URL = 'https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/archive/refs/heads/main.zip';
const COMMITS_API_URL = 'https://api.github.com/repos/administrakt0r/AI-Agents-Safe-Coding-Skills/commits/main';
...
async function syncWithArchive() {
    ...
    try {
        ...
        const extractedRoot = path.join(tempDir, 'AI-Agents-Safe-Coding-Skills-main');
