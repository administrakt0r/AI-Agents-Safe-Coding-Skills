...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Install the library with npx AI-Agents-Safe-Coding-Skills, then use tool-specific flags such as --codex, --cursor, --gemini, or --claude when you want the installer to target a specific skills directory.',
  },
  {
...
function buildOrganizationSchema(): Record<string, unknown> {
  return {
    ...
    '@type': 'Organization',
    name: SITE_NAME,
    url: 'https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills',
    brand: {
      '@type': 'Brand',
      name: SITE_NAME,
    },
...
function buildSoftwareSourceCodeSchema(canonicalUrl: string, visibleCount: number): Record<string, unknown> {
  ...
  return {
    ...
    url: canonicalUrl,
    codeRepository: 'https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills',
    programmingLanguage: {
      '@type': 'ComputerLanguage',
      name: 'Markdown',
      url: 'https://en.wikipedia.org/wiki/Markdown',
    },
    license: 'https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/blob/main/LICENSE',
  };
}
...
export function buildSkillFallbackMeta(skillId: string): SeoMeta {
  ...
  return {
    ...
    description: 'Installable AI skill details are loading. Browse the catalog and launch the right skill with the AI-Agents-Safe-Coding-Skills CLI.',
