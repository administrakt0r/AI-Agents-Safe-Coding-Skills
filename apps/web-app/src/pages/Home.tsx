...
const integrationGuides = [
  {
    name: 'Claude Code',
    href: 'https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/blob/main/docs/users/claude-code-skills.md',
    body: 'Install paths, starter prompts, plugin marketplace flow, and first skills to try.',
  },
  {
    name: 'Cursor',
    href: 'https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/blob/main/docs/users/cursor-skills.md',
    body: 'A practical guide for chat-first UI, frontend, and full-stack workflows in Cursor.',
  },
  {
    name: 'Codex CLI',
    href: 'https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/blob/main/docs/users/codex-cli-skills.md',
    body: 'How to use Antigravity Awesome Skills with Codex CLI for planning, implementation, testing, and review.',
  },
  {
    name: 'Gemini CLI',
    href: 'https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/blob/main/docs/users/gemini-cli-skills.md',
...
export function Home(): React.ReactElement {
  ...
  const installCommand = 'npx AI-Agents-Safe-Coding-Skills';
  const docsLink = 'https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/blob/main/docs/users/usage.md';
  const installLink = 'https://www.npmjs.com/package/AI-Agents-Safe-Coding-Skills';
      ...
      <div className="mt-12 space-y-10">
        <section className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 sm:p-7 shadow-sm">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <a
              href="https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/blob/main/docs/users/skills-vs-mcp-tools.md"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href="https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/blob/main/docs/users/bundles.md"
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center rounded-lg border border-slate-200 dark:border-slate-700 px-4 py-2.5 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800"
            >
            ...
            <a
              href="https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/blob/main/docs/users/workflows.md"
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center rounded-lg border border-slate-200 dark:border-slate-700 px-4 py-2.5 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800"
            >
        ...
        <section className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 sm:p-7 shadow-sm">
          ...
          <a
            href="https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/blob/main/docs/users/faq.md"
            target="_blank"
            rel="noreferrer"
