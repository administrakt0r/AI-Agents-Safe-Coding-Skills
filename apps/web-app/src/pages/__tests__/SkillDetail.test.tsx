...
describe('SkillDetail', () => {
    ...
    it('builds stable markdown candidates for gh-pages routes', () => {
      expect(
        getSkillMarkdownCandidateUrls({
          ...
          pathname: '/AI-Agents-Safe-Coding-Skills/skill/react-patterns',
          documentBaseUrl: 'https://administrakt0r.github.io/AI-Agents-Safe-Coding-Skills/',
          skillPath: 'skills/react-patterns',
        }),
      ).toEqual([
        'https://administrakt0r.github.io/AI-Agents-Safe-Coding-Skills/skills/react-patterns/SKILL.md',
        'https://administrakt0r.github.io/skills/react-patterns/SKILL.md',
        'https://administrakt0r.github.io/AI-Agents-Safe-Coding-Skills/skill/skills/react-patterns/SKILL.md',
        'https://administrakt0r.github.io/AI-Agents-Safe-Coding-Skills/skill/react-patterns/skills/react-patterns/SKILL.md',
      ]);
    });
  });
  ...
  describe('Copy functionality', () => {
    ...
    it('should copy install command when copy command CTA is clicked', async () => {
      ...
      expect(navigator.clipboard.writeText).toHaveBeenCalledWith('npx AI-Agents-Safe-Coding-Skills');
    });
  });
