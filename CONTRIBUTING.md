...
```bash
# 1. Fork and clone
git clone https://github.com/YOUR-USERNAME/AI-Agents-Safe-Coding-Skills.git
cd AI-Agents-Safe-Coding-Skills
...
- **Questions?** Open a [Discussion](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/discussions)
- **Stuck?** Open an [Issue](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/issues)
- **Want feedback?** Open a [Draft Pull Request](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/pulls)

---

## Recognition

All contributors are recognized in our [Contributors](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/graphs/contributors) page.
