...
AI-Agents-Safe-Coding-Skills supports Gemini CLI through the `.gemini/skills/` path and combines general engineering playbooks with specialized skills for AI systems, integrations, infrastructure, testing, product, and growth.

## How to use AI-Agents-Safe-Coding-Skills with Gemini CLI
...
- It helps new users get started with bundles and workflows rather than forcing a cold start from 1,275+ files.
