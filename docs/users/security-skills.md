...
This report lists all security-related skills found in the `AI-Agents-Safe-Coding-Skills` repository, including their descriptions, use cases, and example prompts.
