...
When you ran `npx ai-agents-safe-coding-skills` or cloned the repository, you:

✅ **Downloaded 1,274+ skill files** to your computer (default: `~/.gemini/antigravity/skills/`; or a custom path like `~/.agent/skills/` if you used `--path`)
...
- You installed a toolbox with 1,274+ tools (✅ done)
...
Don't try to use all 1,274+ skills at once. Here's a sensible approach:
...
3. Try the explicit path: `npx ai-agents-safe-coding-skills --claude` (or `--cursor`, `--gemini`, etc.)

### "Can I load all skills into the model at once?"

No. Even though you have 1,274+ skills installed locally, you should **not** concatenate every `SKILL.md` into a single system prompt or context block.
...
3. [Open an issue](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/issues) with details
...
3. [Open a Discussion](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/discussions)
4. [File an Issue](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/issues) to help us improve this guide!
