...
- **Domain expertise** across 1,274+ specialized areas
...
git clone https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills.git ~/.kiro/skills
```
...
- **Issues**: [GitHub Issues](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/issues)
- **Discussions**: [GitHub Discussions](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/discussions)
