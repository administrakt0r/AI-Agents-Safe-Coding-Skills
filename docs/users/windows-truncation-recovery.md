...
The following script is adapted from the community recovery workflow shared by [@DiggaX](https://github.com/DiggaX) in [issue #274](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/issues/274). Review it before running it.
