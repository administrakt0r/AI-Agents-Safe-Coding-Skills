...
This example shows one way to integrate **AI-Agents-Safe-Coding-Skills** with a Jetski/Cortex‑style agent using **lazy loading** based on `@skill-id` mentions, instead of concatenating every `SKILL.md` into the prompt.
...
This pattern avoids context overflow when you have 1,275+ skills installed.
...
const REPO_ROOT = "/path/to/AI-Agents-Safe-Coding-Skills";
