...
- **Evidence reviewed:** `SKILL.md` contained a deprecation notice and a migration section pointing to `azure-monitor-opentelemetry-autoconfigure` as the recommended approach.
- **Files changed:**
