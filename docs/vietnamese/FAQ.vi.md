...
```bash
git clone -c core.symlinks=true https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills.git .agent/skills
```
...
Hãy [Mở một issue](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/issues)!  
Vui lòng gửi kèm:
...
**Vẫn còn thắc mắc?** [Mở một cuộc thảo luận (Discussion)](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/discussions) và chúng tôi sẽ giúp bạn! 🙌
