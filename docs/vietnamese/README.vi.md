...
[![Antigravity](https://img.shields.io/badge/Antigravity-DeepMind-red)](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills)
...
git clone https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills.git .claude/skills

# Dành riêng cho Gemini CLI
git clone https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills.git .gemini/skills

# Dành riêng cho Cursor
git clone https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills.git .cursor/skills
```
