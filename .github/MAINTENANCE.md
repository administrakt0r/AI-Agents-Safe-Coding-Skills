...
This guide details the exact procedures for maintaining `AI-Agents-Safe-Coding-Skills`.
...
5.  **Push to the contributor's fork.** Add their fork as a remote if needed (replace `USER` and `BRANCH` with the PR head owner and branch from the PR page):
    ```bash
    git remote add <user>-fork https://github.com/<USER>/AI-Agents-Safe-Coding-Skills.git
...
We used this flow for PRs [#220](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/pull/220), [#224](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/pull/224), and [#225](https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/pull/225) after they had been integrated locally and closed.
...
- **Antigravity Badge**: Must point to `https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills`, NOT `anthropics/antigravity`.
...
- Current live discussion: `https://github.com/administrakt0r/AI-Agents-Safe-Coding-Skills/discussions/361`
